...
class MEMORY {
  public:
    ...
    // stats
    uint64_t back_hits, dirty_back_hits, inter_back_hits, intra_back_hits, l2c_back_hits, llc_back_hits;
    uint64_t roi_back_hits, roi_dirty_back_hits, roi_inter_back_hits, roi_intra_back_hits, roi_l2c_back_hits, roi_llc_back_hits;
    uint64_t inclusive_stall, roi_inclusive_stall;
    ...
    MEMORY() {
        for (uint32_t i=0; i<NUM_TYPES; i++) {
	        ...
	        back_hits = 0;
                ...
                llc_back_hits = 0;
                roi_back_hits = 0;
                roi_dirty_back_hits = 0;
                roi_inter_back_hits = 0;
                roi_intra_back_hits = 0;
                roi_l2c_back_hits = 0;
                roi_llc_back_hits = 0;
                inclusive_stall = 0;
                roi_inclusive_stall = 0;
