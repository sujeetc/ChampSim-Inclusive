...
void record_roi_stats(uint32_t cpu, CACHE *cache)
{
    ...
    cache->roi_back_hits = cache->back_hits;
    cache->roi_dirty_back_hits = cache->dirty_back_hits;
    cache->roi_intra_back_hits = cache->intra_back_hits;
    cache->roi_inter_back_hits = cache->inter_back_hits;
    cache->roi_l2c_back_hits = cache->l2c_back_hits;
    cache->roi_llc_back_hits = cache->llc_back_hits;
    cache->roi_inclusive_stall = cache->inclusive_stall;
